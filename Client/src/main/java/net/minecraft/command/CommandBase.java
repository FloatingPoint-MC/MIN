...
public abstract class CommandBase implements ICommand {
    ...
    public static <T extends Entity> T getEntity(MinecraftServer server, ICommandSender sender, String target, Class<? extends T> targetClass) throws CommandException {
     ...
     */
    public static Block getBlockByText(String id) throws NumberInvalidException {
        ResourceLocation resourcelocation = new ResourceLocation(id);
    ...
    private static <T extends Comparable<T>> T getValueHelper(IProperty<T> p_190792_0_, String p_190792_1_) {
        return p_190792_0_.parseValue(p_190792_1_).orElse(null);
    }
