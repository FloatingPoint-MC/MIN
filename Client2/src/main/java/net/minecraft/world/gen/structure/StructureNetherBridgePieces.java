...
public class StructureNetherBridgePieces
{
    ...
    public static class Start extends Crossing3
    {
        ...
        public Start(Random p_i2059_1_, int p_i2059_2_, int p_i2059_3_)
        {
            ...
            for (PieceWeight structurenetherbridgepieces$pieceweight : StructureNetherBridgePieces.PRIMARY_COMPONENTS)
            {
            ...
            for (PieceWeight structurenetherbridgepieces$pieceweight1 : StructureNetherBridgePieces.SECONDARY_COMPONENTS)
            {
