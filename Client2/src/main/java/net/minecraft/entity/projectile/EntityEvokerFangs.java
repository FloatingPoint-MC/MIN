...
public class EntityEvokerFangs extends Entity
{
    ...
    public EntityEvokerFangs(World worldIn, double x, double y, double z, float p_i47276_8_, int p_i47276_9_, @Nullable EntityLivingBase casterIn)
    {
        this(worldIn);
    ...
    private void damage(EntityLivingBase p_190551_1_)
    {
        ...
        if (p_190551_1_.isEntityAlive() && p_190551_1_.getVulnerable() && p_190551_1_ != entitylivingbase)
        {
