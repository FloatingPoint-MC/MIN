...
public class GuiVideoSettings extends GuiScreenOF {
    ...
    private void actionPerformed(GuiButton guiButton, int p_actionPerformed_2_) {
        if (guiButton.enabled) {
            ...
            if (guiButton.id < 200 && guiButton instanceof GuiOptionButton) {
                ...
                guiButton.displayString = this.guiGameSettings.getKeyBinding(Objects.requireNonNull(GameSettings.Options.byOrdinal(guiButton.id)));
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String s = "OptiFine HD G6_pre1 Ultra";
