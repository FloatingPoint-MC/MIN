        ...
        else
        {
            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                else if (entity.world != null)
                {
                    ...
                    CoordinateArg commandbase$coordinatearg3 = parseCoordinate(entity.rotationYaw, args.length > k ? args[k++] : "~", false);
                    CoordinateArg commandbase$coordinatearg4 = parseCoordinate(entity.rotationPitch, args.length > k ? args[k] : "~", false);
