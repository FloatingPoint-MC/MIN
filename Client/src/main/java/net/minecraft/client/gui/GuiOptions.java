...
public class GuiOptions extends GuiScreen {
    ...
    public void initGui() {
        ...
        int i = 0;
        this.buttonList.add(new GuiButton(666, this.width / 2 - 155, this.height / 6 + 18, 150, 20, "BetterFPS"));
    ...
    public String getDifficultyText(EnumDifficulty p_175355_1_) {
        ...
        itextcomponent.appendSibling(new TextComponentTranslation(p_175355_1_.getTranslationKey()));
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id < 100 && button instanceof GuiOptionButton) {
                ...
                button.displayString = this.settings.getKeyBinding(Objects.requireNonNull(GameSettings.Options.byOrdinal(button.id)));
            }
            ...
            if (button.id == 109) {
                this.mc.displayGuiScreen(new GuiYesNo(this, (new TextComponentTranslation("difficulty.lock.title")).getFormattedText(), (new TextComponentTranslation("difficulty.lock.question", new TextComponentTranslation(Objects.requireNonNull(this.mc.world.getWorldInfo().getDifficulty()).getTranslationKey()))).getFormattedText(), 109));
            }
