...
public class RenderGuardian extends RenderLiving<EntityGuardian>
{
    ...
    public void doRender(EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            double d4 = 0.0D + MathHelper.cos((float) (d1 + 2.356194490192345D)) * 0.282D;
            double d5 = 0.0D + MathHelper.sin((float) (d1 + 2.356194490192345D)) * 0.282D;
            double d6 = 0.0D + MathHelper.cos((float) (d1 + (Math.PI / 4D))) * 0.282D;
            double d7 = 0.0D + MathHelper.sin((float) (d1 + (Math.PI / 4D))) * 0.282D;
            double d8 = 0.0D + MathHelper.cos((float) (d1 + 3.9269908169872414D)) * 0.282D;
            double d9 = 0.0D + MathHelper.sin((float) (d1 + 3.9269908169872414D)) * 0.282D;
            double d10 = 0.0D + MathHelper.cos((float) (d1 + 5.497787143782138D)) * 0.282D;
            double d11 = 0.0D + MathHelper.sin((float) (d1 + 5.497787143782138D)) * 0.282D;
            double d12 = 0.0D + MathHelper.cos((float) (d1 + Math.PI)) * 0.2D;
            double d13 = 0.0D + MathHelper.sin((float) (d1 + Math.PI)) * 0.2D;
            double d14 = 0.0D + MathHelper.cos((float) (d1 + 0.0D)) * 0.2D;
            double d15 = 0.0D + MathHelper.sin((float) (d1 + 0.0D)) * 0.2D;
            double d16 = 0.0D + MathHelper.cos((float) (d1 + (Math.PI / 2D))) * 0.2D;
            double d17 = 0.0D + MathHelper.sin((float) (d1 + (Math.PI / 2D))) * 0.2D;
            double d18 = 0.0D + MathHelper.cos((float) (d1 + (Math.PI * 3D / 2D))) * 0.2D;
            double d19 = 0.0D + MathHelper.sin((float) (d1 + (Math.PI * 3D / 2D))) * 0.2D;
            double d22 = -1.0F + f3;
