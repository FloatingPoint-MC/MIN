...
public abstract class MapGenStructure extends MapGenBase {
    ...
    protected final synchronized void recursiveGenerate(World worldIn, final int chunkX, final int chunkZ, int originalX, int originalZ, ChunkPrimer chunkPrimerIn) {
        ...
        if (!this.structureMap.containsKey(ChunkPos.asLong(chunkX, chunkZ))) {
            ...
            try {
                ...
                crashreportcategory.addDetail("Is feature chunk", () -> MapGenStructure.this.canSpawnStructureAtCoords(chunkX, chunkZ) ? "True" : "False");
    ...
    protected void initializeStructureData(@Nullable World worldIn) {
    ...
    @Nullable
    protected static BlockPos findNearestStructurePosBySpacing(World worldIn, MapGenStructure structureType, BlockPos startPos, int distanceStep, int stepOffset, int randomSeedZ, boolean addExtraRandomness, boolean findUnexplored) {
