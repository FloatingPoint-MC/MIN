...
public class JsonUtils {
     ...
     */
    public static boolean hasField(@Nullable JsonObject json, String memberName) {
        if (json == null) {
            return false;
        } else {
     ...
     */
    @Nullable
    public static String getString(JsonObject json, String memberName, @Nullable String fallback) {
     ...
     */
    public static String toString(@Nullable JsonElement json) {
