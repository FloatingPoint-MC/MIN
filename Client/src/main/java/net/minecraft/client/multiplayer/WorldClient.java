...
public class WorldClient extends World {
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension, EnumDifficulty difficulty, Profiler profilerIn) {
        ...
        Managers.moduleManager.modules.values().forEach(module -> {
            if (module.shouldEnableOnStartUp()) {
                module.setEnableOnStartUp(false);
    ...
    public void setClientChunkProvider(ChunkProviderClient provider) {
        this.clientChunkProvider = provider;
    }
}
