...
public class ItemRenderer {
            ...
            if (stack.isEmpty()) {
                ...
                if (player.isHandActive() && player.getItemInUseCount() > 0 && player.getActiveHand() == hand) {
                    ...
                    switch (stack.getItemUseAction()) {
                        ...
                        case BLOCK:
                            this.transformFirstPersonItem(enumhandside == EnumHandSide.RIGHT ? 1.0F : -1.0F, p_187457_7_, 0.0f);
                            break;
    ...
    public void updateEquippedItem() {
        ...
        if (entityplayersp.isRowingBoat()) {
            ...
            this.equippedProgressMainHand += MathHelper.clamp((Objects.equals(this.itemStackMainHand, itemstack) ? 1.0F : 0.0F) - this.equippedProgressMainHand, -0.4F, 0.4F);
