...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer<TileEntityBeacon> {
    ...
    public static void renderBeamSegment(double x, double y, double z, double partialTicks, double textureScale, double totalWorldTime, int yOffset, int height, float[] colors, double beamRadius, double glowRadius) {
        if (BetterFpsHelper.getConfig().beaconBeam) {
            ...
            double d1 = height < 0 ? time : -time;
            double d2 = MathHelper.frac(d1 * 0.2D - (double)MathHelper.floor(d1 * 0.1D));
            float r = colors[0];
            float g = colors[1];
            float b = colors[2];
            double d3 = time * 0.025D * -1.5D;
            double d4 = 0.5D + MathHelper.cos((float) (d3 + 2.356194490192345D)) * beamRadius;
            double d5 = 0.5D + MathHelper.sin((float) (d3 + 2.356194490192345D)) * beamRadius;
            double d6 = 0.5D + MathHelper.cos((float) (d3 + (Math.PI / 4D))) * beamRadius;
            double d7 = 0.5D + MathHelper.sin((float) (d3 + (Math.PI / 4D))) * beamRadius;
            double d8 = 0.5D + MathHelper.cos((float) (d3 + 3.9269908169872414D)) * beamRadius;
            double d9 = 0.5D + MathHelper.sin((float) (d3 + 3.9269908169872414D)) * beamRadius;
            double d10 = 0.5D + MathHelper.cos((float) (d3 + 5.497787143782138D)) * beamRadius;
            double d11 = 0.5D + MathHelper.sin((float) (d3 + 5.497787143782138D)) * beamRadius;
            double d14 = -1.0D + d2;
            ...
            vertexbuffer.pos(x + d4, y + (double)yOffset, z + d5).tex(1.0D, d14).color(r, g, b, 1.0F).endVertex();
            vertexbuffer.pos(x + d6, y + (double)yOffset, z + d7).tex(0.0D, d14).color(r, g, b, 1.0F).endVertex();
            ...
            vertexbuffer.pos(x + d10, y + (double)yOffset, z + d11).tex(1.0D, d14).color(r, g, b, 1.0F).endVertex();
            vertexbuffer.pos(x + d8, y + (double)yOffset, z + d9).tex(0.0D, d14).color(r, g, b, 1.0F).endVertex();
            ...
            vertexbuffer.pos(x + d6, y + (double)yOffset, z + d7).tex(1.0D, d14).color(r, g, b, 1.0F).endVertex();
            vertexbuffer.pos(x + d10, y + (double)yOffset, z + d11).tex(0.0D, d14).color(r, g, b, 1.0F).endVertex();
            ...
            vertexbuffer.pos(x + d8, y + (double)yOffset, z + d9).tex(1.0D, d14).color(r, g, b, 1.0F).endVertex();
            vertexbuffer.pos(x + d4, y + (double)yOffset, z + d5).tex(0.0D, d14).color(r, g, b, 1.0F).endVertex();
