...
public abstract class EntityPlayer extends EntityLivingBase {
    ...
    /**
     * Offset in the X axis used for rendering. This field is {@linkplain #setRenderOffsetForSleep(EnumFacing)} () used by beds.
     */
    ...
    /**
     * Offset in the Z axis used for rendering. This field is {@linkplain #setRenderOffsetForSleep(EnumFacing)} () used by beds.
     */
    ...
    public void onUpdate() {
        ...
        double d0 = MathHelper.clamp(this.posX, -29999999D, 29999999D);
        double d1 = MathHelper.clamp(this.posZ, -29999999D, 29999999D);
    ...
    protected void updateEntityActionState() {
        ...
        this.rotationYawHead = this.rotationYaw + Spinning.getCurrent(this);
        ...
        if (targetEntity.canBeAttackedWithItem()) {
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    boolean flag = this.fallDistance > 0.0F && !this.onGround && !this.isOnLadder() && !this.isInWater() && !this.isPotionActive(MobEffects.BLINDNESS) && !this.isRiding() && targetEntity instanceof EntityLivingBase;
    ...
    public SleepResult trySleep(BlockPos bedLocation) {
        ...
        if (!this.world.isRemote) {
            ...
            List<EntityMob> list = this.world.getEntitiesWithinAABB(EntityMob.class, new AxisAlignedBB((double) bedLocation.getX() - 8.0D, (double) bedLocation.getY() - 5.0D, (double) bedLocation.getZ() - 8.0D, (double) bedLocation.getX() + 8.0D, (double) bedLocation.getY() + 5.0D, (double) bedLocation.getZ() + 8.0D), new SleepEnemyPredicate(this));
     ...
     * Entity#getDisplayName() Entity.getDisplayName()}</dt>
