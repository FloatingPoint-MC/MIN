...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleSpawnPlayer(SPacketSpawnPlayer packetIn) {
        ...
        EntityOtherPlayerMP entityotherplayermp = new EntityOtherPlayerMP(this.client.world, Objects.requireNonNull(this.getPlayerInfo(packetIn.getUniqueId())).getGameProfile());
        ...
        if (this.validateResourcePackUrl(s)) {
            if (s.startsWith("level://")) {
                ...
                if (serverdata != null && serverdata.getResourceMode() == ServerData.ServerResourceMode.ENABLED) {
                    ...
                    this.client.addScheduledTask(() -> NetHandlerPlayClient.this.client.displayGuiScreen(new GuiYesNo((result, id) -> {
            ...
            if (!(entity instanceof EntityLivingBase)) {
                ...
                for (SPacketEntityProperties.Snapshot spacketentityproperties$snapshot : packetIn.getSnapshots()) {
                    ...
                    if (iattributeinstance == null) {
                        iattributeinstance = abstractattributemap.registerAttribute(new RangedAttribute(null, spacketentityproperties$snapshot.getName(), 0.0D, 0.0D, Double.MAX_VALUE));
                    }
