...
public class ModelDragon extends ModelBase {
     ...
     */
    public final ModelRenderer spine;
     ...
     */
    public final ModelRenderer wingTip;
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        this.jaw.rotateAngleX = (float) (MathHelper.sin(f * ((float) Math.PI * 2F)) + 1.0D) * 0.2F;
        float f1 = (float) (MathHelper.sin(f * ((float) Math.PI * 2F) - 1.0F) + 1.0D);
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            float f9 = (float) MathHelper.cos((float) i * 0.45F + f8) * 0.15F;
            ...
            f2 = (float) ((double) f2 + MathHelper.sin(this.spine.rotateAngleX) * 10.0D);
            f3 = (float) ((double) f3 - MathHelper.cos(this.spine.rotateAngleY) * MathHelper.cos(this.spine.rotateAngleX) * 10.0D);
            f4 = (float) ((double) f4 - MathHelper.sin(this.spine.rotateAngleY) * MathHelper.cos(this.spine.rotateAngleX) * 10.0D);
        ...
        for (int j = 0; j < 2; ++j) {
            ...
            this.wing.rotateAngleX = 0.125F - (float) MathHelper.cos(f11) * 0.2F;
            this.wing.rotateAngleY = 0.25F;
            this.wing.rotateAngleZ = (float) (MathHelper.sin(f11) + 0.125D) * 0.8F;
            this.wingTip.rotateAngleZ = -((float) (MathHelper.sin(f11 + 2.0F) + 0.5D)) * 0.75F;
        ...
        float f10 = -((float) MathHelper.sin(f * ((float) Math.PI * 2F))) * 0.0F;
        ...
        for (int k = 0; k < 12; ++k) {
            ...
            f10 = (float) ((double) f10 + MathHelper.sin((float) k * 0.45F + f8) * 0.05000000074505806D);
