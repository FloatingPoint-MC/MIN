...
public class ModelSilverfish extends ModelBase
{
    ...
    public ModelSilverfish()
    {
        ...
        this.silverfishWings[0].setRotationPoint(0.0F, 16.0F, zPlacement[2]);
        ...
        this.silverfishWings[1].setRotationPoint(0.0F, 20.0F, zPlacement[4]);
        ...
        this.silverfishWings[2].setRotationPoint(0.0F, 19.0F, zPlacement[1]);
    }
