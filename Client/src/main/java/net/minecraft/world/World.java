...
public abstract class World implements IBlockAccess {
     ...
     */
    public boolean checkBlockDoesNotContainCollision(AxisAlignedBB bb) {
        ...
        for (int l3 = j2; l3 < k2; ++l3) {
            for (int i4 = l2; i4 < i3; ++i4) {
                for (int j4 = j3; j4 < k3; ++j4) {
                    IBlockState blockState = this.getBlockState(pooledMutableBlockPos.setPos(l3, i4, j4));
                ...
                for (int i4 = l2; i4 < i3; ++i4) {
                    for (int j4 = j3; j4 < k3; ++j4) {
                        ...
                        if (iblockstate1.getMaterial() == materialIn) {
                            double d0 = (float) (i4 + 1) - BlockLiquid.getLiquidHeightPercent(iblockstate1.getValue(BlockLiquid.LEVEL));
    ...
    public boolean isBlockNotFullCube(BlockPos pos) {
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance, Predicate<Entity> predicate) {
        ...
        for (int j2 = this.playerEntities.size() - 1; j2 >= 0; --j2) {
    ...
    public EntityPlayer getNearestAttackablePlayer(double posX, double posY, double posZ, double maxXZDistance, double maxYDistance, @Nullable Function<EntityPlayer, Double> playerToDouble, @Nullable Predicate<EntityPlayer> predicate) {
        ...
        for (EntityPlayer entityplayer1 : this.playerEntities) {
    ...
    public CrashReportCategory addWorldInfoToCrashReport(CrashReport report) {
        ...
        crashreportcategory3.addDetail("All players", () -> World.this.playerEntities.size() + " total; " + World.this.playerEntities);
        crashreportcategory3.addDetail("Chunk stats", () -> World.this.chunkProvider.makeString());
