...
public class Registry extends Util {
     ...
     * @param extString is a string of extensions separated by blank(s). There may or may not be leading or trailing
     *                  blank(s) in extString. This works in cases of extensions being prefixes of another like
    ...
    public static boolean gluCheckExtension(String extName, String extString) {
        ...
        return extString.contains(extName);
    }
}
